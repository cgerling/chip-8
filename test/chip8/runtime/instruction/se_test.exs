defmodule Chip8.Runtime.Instruction.SETest do
  use ExUnit.Case, async: true

  alias Chip8.Runtime
  alias Chip8.Runtime.Instruction.Argument.Byte
  alias Chip8.Runtime.Instruction.Argument.Register
  alias Chip8.Runtime.Instruction.SE
  alias Chip8.Runtime.VRegisters

  describe "execute/2" do
    test "should return a runtime with pc set to next instruction when vx is equals to the given byte" do
      runtime = Runtime.new()
      x = :rand.uniform(0xF)
    ...
    test "should return a runtime with pc unchanged when vx is not equals to the given byte" do
      runtime = Runtime.new()
      x = :rand.uniform(0xF)
      x_value = 0x95
    ...
    test "should return a runtime with pc set to next instruction when vx is equals to vy" do
      runtime = Runtime.new()
    ...
    test "should return a runtime with pc unchanged when vx is not equals to vy" do
      runtime = Runtime.new()
      x = 0xE
      x_value = 0x95
      y = 0x4
